...
contract BaseERC3009Tests is TestUtils {
    string internal constant _TOKEN_NAME = "ERC3009 Token";
    string internal constant _TOKEN_SYMBOL = "ERC3009_TKN";
    uint8 internal constant _TOKEN_DECIMALS = 0;
    ...
    IERC20ExtendedHarness internal _token;
